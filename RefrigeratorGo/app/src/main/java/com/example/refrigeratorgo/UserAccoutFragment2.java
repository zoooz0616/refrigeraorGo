...
public class UserAccoutFragment2 extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        view = inflater.inflate(R.layout.useraccount_fragment2, null);
    ...
    private void init() {
        RecyclerView recyclerView = view.findViewById(R.id.rvF2);
